...
const STATS: StatType[] = [
    { id: "projects", value: 10, suffix: "+", label: "Projects Built", description: "Web apps, dashboards & automation tools", icon: faCode },
    { id: "experience", value: 3, suffix: "+", label: "Years Experience", description: "Engineering, analytics & software development", icon: faBriefcase },
    { id: "platforms", value: 5, suffix: "+", label: "Platforms Automated", description: "Reporting, tracking & business workflows", icon: faLayerGroup }
];
...
function StatItem({ stat, index, isLast }: { stat: StatType; index: number; isLast: boolean }) {
    ...
    return (
        <motion.article
            ...
            className={`group relative px-5 py-8 sm:px-6 lg:px-8 transition-colors duration-300 border-[var(--border)] ${isLast ? "" : "border-b sm:border-b-0 sm:border-r"}`}
